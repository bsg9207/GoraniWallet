...
export const OpenWalletFromPrivateKey = openWalletFromPrivateKey;
export const OpenWalletFromKeystoreV3 = openWalletFromKeystoreV3;
export const OpenHDWallet = openHDWallet;
export const OpenWalletFromMnemonic = openWalletFromMnemonic;
